    ...
    <footer className="bg-[#13110e] pt-16 pb-8 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            <h4 className="text-xs uppercase tracking-wider text-gray-500 font-medium mb-4">Product</h4>
          ...
          <div>
            <h4 className="text-xs uppercase tracking-wider text-gray-500 font-medium mb-4">Resources</h4>
            <ul className="space-y-3">
