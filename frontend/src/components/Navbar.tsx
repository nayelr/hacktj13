      ...
      <div className="glass-nav rounded-full px-6 py-3 flex items-center gap-8 border border-gray-800">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/pentra" className="text-sm text-gray-400 hover:text-white transition-colors">Launch Test</Link>
            <Link href="/#stats" className="text-sm text-gray-400 hover:text-white transition-colors">How It Works</Link>
            <Link href="/#contact" className="text-sm text-gray-400 hover:text-white transition-colors">Contact</Link>
          </div>
        </div>
        <Link href="/pentra" className="bg-white text-black text-sm font-medium px-4 py-2 rounded-full hover:bg-gray-100 transition-colors">Launch penetration test</Link>
      </div>
    </nav>
  );
}
